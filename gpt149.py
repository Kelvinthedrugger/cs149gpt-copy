...
mr = load(name="custom_module", sources=["module.cpp"],  extra_cflags=["-mcpu=native","-mllvm -force-vector-width=8","-O3", "-fopenmp"])
#mr = load(name="custom_module", sources=["module.cpp"],  extra_cflags=["-O3"])#, extra_ldflags=[ispc_path])
