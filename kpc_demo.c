// ref: https://gist.github.com/ibireme/173517c208c7dc333ba962c1f0d67d12
// =============================================================================
// XNU kperf/kpc demo
...
static double total_profile_time = 3; // 0.1;
...
int main(int argc, char *argv[]) {
  // if argc > 1: run main2(): profile specified program
  if (argc > 1) {
    // enter the pid as well
